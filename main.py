def main():
   ...
   ##################################################
    ...
    overtime = workhours - reg_hours     # complete this statement to calcualte overtime
    overtime_wage = overtime * ov_rate # complete this statement to calculate overtime wage
    regular_wage = reg_hours * reg_rate
    total_wage = regular_wage + overtime_wage
